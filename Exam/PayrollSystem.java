...
public class PayrollSystem extends JFrame {
    ...
    public PayrollSystem() {
        ...
        // Set up colors
        Color primaryColor = new Color(33, 150, 243); // Dark gray-blue
        Color secondaryColor = new Color(255, 255, 255); // Light gray
        Color accentColor = new Color(255, 105, 180); // Soft blue
        Color buttonColor = new Color(33, 150, 243); // Green
